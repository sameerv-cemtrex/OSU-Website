...
const Hero = () => {
  return (
    <div className="relative hero-bg min-h-screen pt-10 pb-[52px]">
      {/* <div className="absolute inset-0 hero-gradient  bg-blend-overlay" /> */}
      <div className="container grid place-items-center relative">
        <img
          ...
          alt="logo"
        />
        <h1 className="font-grozen-medical font-bold pt-72 text-[56px] w-[836px] leading-[60px] text-center font-">
      ...
      {/* Hero cards */}
      <div className="container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 space-x-4 mt-[152px]">
